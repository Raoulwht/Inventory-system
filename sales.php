...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row">
			<button class="col-md-2 float-right btn btn-primary btn-sm" id="new_sales"><i class="fa fa-plus"></i> New Outing</button>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="card">
						...
						<table class="table table-bordered">
							...
							?>
								<tr>
									...
									<td class=""><?php echo date("M-d-Y / h:i:sa",strtotime($row['date_updated'])) ?></td>
